...
if (!$jam_kerja) {
    ...
    $jam_kerja = ['buka' => '07:00:00', 'tutup' => '14:00:00'];
}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert <?= $sistem_buka ? 'alert-success' : 'alert-danger' ?> mb-3">
                    <i class="fas fa-clock me-2"></i>
                    <strong>Sistem Pemesanan: <?= $sistem_buka ? 'BUKA' : 'TUTUP' ?></strong>
                    <span class="ms-2">(Jam Operasional: <?= date('H:i', strtotime($jam_kerja['buka'])) ?> - <?= date('H:i', strtotime($jam_kerja['tutup'])) ?>)</span>
                </div>
                ...
                <form id="formInputPesanan" action="pages/simpan_pesanan_manual.php" method="POST">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" onclick="cariDataAnggota()">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea type="text" class="form-control" name="alamat_pemesan" required></textarea>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-sm" id="tabelProduk">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <select class="form-select form-select-sm" id="pilihProduk" onchange="updateProdukInfo()">
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="satuanProduk" readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="hargaProduk" readonly>
                                    </td>
                                    <td>
                                        <span id="stokInfo" class="form-control-plaintext form-control-sm"></span>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" id="qtyProduk" min="1" value="1" 
                                               onchange="validasiStok()" onkeyup="validasiStok()">
                                        <small id="pesanStok" class="text-danger" style="display: none; font-size: 0.8rem;"></small>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahProduk()" id="btnTambahProduk">
