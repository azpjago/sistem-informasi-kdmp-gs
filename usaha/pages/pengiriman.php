    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <div>
                    <i class="fas fa-truck me-2"></i>Manajemen Pengiriman - <?= date('d F Y', strtotime($filter_tanggal)) ?>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="filterTanggal" value="<?= $filter_tanggal ?>" onchange="applyFilter()">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="filterStatus" onchange="applyFilter()">
                            ...
                            <option value="Belum Dikirim" <?= $filter_status == 'Belum Dikirim' ? 'selected' : '' ?>>Belum Dikirim</option>
                            <option value="Assign Kurir" <?= $filter_status == 'Assign Kurir' ? 'selected' : '' ?>>Assign Kurir</option>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($pesanan)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted">
                                                Tgl Kirim: <?= $row['tgl_pengiriman_actual'] ? date('d/m/Y', strtotime($row['tgl_pengiriman_actual'])) : '<span class="text-warning">Belum di-set</span>' ?>
                                            </small>
                                        </td>
                                        <td>
                                    ...
                                    <td colspan="8" class="text-center text-muted py-5">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <p class="mb-1"><strong>Tanggal:</strong> <?= date('d F Y', strtotime($filter_tanggal)) ?></p>
                                                        <p class="mb-1"><strong>Status:</strong> <?= $filter_status == 'semua' ? 'Semua Status' : $filter_status ?></p>
                                                        <?php if ($filter_kurir): ?>
                                                            <p class="mb-1"><strong>Kurir:</strong> <?= getNamaKurir($conn, $filter_kurir) ?></p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Tanggal Pengiriman:</label>
                        <input type="date" class="form-control" id="assignTanggalPengiriman" value="<?= $filter_tanggal ?>" required>
