...
function log_pengajuan_pengeluaran($pengeluaran_id, $keterangan, $jumlah, $sumber_dana, $user_type = null)
{
    $session_info = get_session_user_info();
    $user_id = $session_info['user_id'];
    $user_role = $user_type ?: $session_info['user_role'];
...
function log_approval_pengeluaran($pengeluaran_id, $keterangan, $jumlah, $sumber_dana, $user_type = null)
{
    $session_info = get_session_user_info();
    $user_id = $session_info['user_id'];
    $user_role = $user_type ?: $session_info['user_role'];
...
function log_rejection_pengeluaran($pengeluaran_id, $keterangan, $jumlah, $sumber_dana, $alasan, $user_type = null)
{
    $session_info = get_session_user_info();
    $user_id = $session_info['user_id'];
    $user_role = $user_type ?: $session_info['user_role'];
...
function log_edit_pengeluaran($pengeluaran_id, $keterangan, $jumlah, $sumber_dana, $user_type = null)
{
    $session_info = get_session_user_info();
    $user_id = $session_info['user_id'];
    $user_role = $user_type ?: $session_info['user_role'];
...
function log_hapus_pengeluaran($pengeluaran_id, $keterangan, $jumlah, $sumber_dana, $user_type = null)
{
    $session_info = get_session_user_info();
    $user_id = $session_info['user_id'];
    $user_role = $user_type ?: $session_info['user_role'];
