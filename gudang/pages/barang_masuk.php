...
if ($q_bagus > 0) {
    ...
    $update_status = "UPDATE barang_masuk SET status = 'done' WHERE id_barang_masuk = '$id_barang_masuk'";
...
<head>
    ...
    <style>
        ...
        .badge-qc { background-color: #17a2b8; }
        .badge-lulus { background-color: #28a745; }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="penerima" class="form-control" value="<?php echo isset($_SESSION['nama']) ? $_SESSION['nama'] : ''; ?>">
                    </div>
                </div>
