        ...
        <div class="modal fade" id="modalUploadBukti" tabindex="-1" aria-labelledby="modalUploadBuktiLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formUploadBukti" action="upload_bukti_tambahan.php" method="POST"
        ...
        <script>
            ...
            $('#metode').on('change', function () {
                if ($(this).val() === 'transfer') {
                    ...
                    $('#bank_tujuan_update_container').hide();
                    $('#bank_tujuan_update').prop('required', false);
                }
            });
            // ==========================================================
